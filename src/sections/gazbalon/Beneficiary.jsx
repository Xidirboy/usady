...
const Beneficiary = ({ insuranceData, setInsuranceData }) => {
        ...
        .then((r) => {
          if (r?.data?.data?.PINFL) {
            setInsuranceData({
              ...insuranceData,
              beneficiary: sdata,
              beneficiary_result: r?.data?.data ?? {},
            });
            setStage(2);
            setErrors({
              ...errors,
  ...
  return (
    <>
      <div className="sub_title">{t("gaz_balon_step2.beneficiary")}</div>
          ...
          {stage > 1 ? (
            <div>
              <Input
                ...
                value={`${insuranceData?.beneficiary_result?.LAST_NAME} ${insuranceData?.beneficiary_result?.FIRST_NAME} ${insuranceData?.beneficiary_result?.MIDDLE_NAME}`}
                is_icon={false}
                is_disabled={true}
              />
            </div>
            ...
            {stage > 1 ? (
              <div>
                <Input
                  ...
                  value={insuranceData?.beneficiary_result?.PINFL}
                  is_icon={false}
                  is_disabled={true}
                />
              </div>
