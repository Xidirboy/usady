...
import { HistoryPaidContainer } from "../../styleComponents/components/profile_pages_style/HistoryPaidStyle";
...
const HistoryPaid = () => {
  ...
  return (
    ...
    <CheckUser is_requaried={true} />
      <Layout>
        <Navigator
          active={t("profile.history")}
          navs={[{ title: t("profile.account"), link: "/profile" }]}
        />
        <HistoryPaidContainer>
            ...
            <div className="content">
              <TableComp>
                <table>
                  <thead>
                    <tr>
                      <td>{t("history_paid.date")}</td>
                      <td>{t("history_paid.price")}</td>
                      <td>{t("history_paid.type")}</td>
                    </tr>
                  </thead>
                  <tbody>
                    <tr>
                      <td colSpan={3}>{t("history_paid.no_dara")}</td>
                    </tr>
                    {/* <tr>
                      <td>24.01.2023</td>
                      <td>2 000 000 р.</td>
