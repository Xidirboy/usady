...
import CaruselCard from '../../sections/componentSections/CaruselCard';
	...
	return (
		<AppViewStyle>
			...
			<div className='container_main '>
				...
				<div>
					<h3 style={{ color: 'rgb(43, 63, 90)', fontSize: '32px', fontWeight: '600' }}>Оформить тур онлайн по лучшей цене</h3>
					<CaruselCard />
				</div>
